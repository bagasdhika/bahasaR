...
#harus install RTools https://cran.r-project.org/bin/windows/Rtools/Rtools34.exe
#harus install RTools https://cran.r-project.org/bin/windows/Rtools/Rtools34.exe
...
ggplot(sent_df, aes(x=emotion)) +geom_bar(aes(y=..count.., fill=emotion)) +scale_fill_brewer(palette="Dark2") +labs(x="emotion categories", y="number of tweets")
